    ...
    compile() {
        ...
        for (const rule of this.rules) {
            ...
            if (typeof rule === 'object') {
                // @ts-ignore
                compiledRule = ruleCompiler_1.RuleCompiler.compile(rule.rule);
            }
            else {
                compiledRule = ruleCompiler_1.RuleCompiler.compile(rule);
            }
            if (!this.readOnly) {
                // @ts-ignore
...
exports.CompiledRules = CompiledRules;
